...
if __name__ == '__main__':
    ...
    #host_1.udt_send('H3', 'MESSAGE 1 FROM_H1', 0)
    #host_2.udt_send('H3', 'MESSAGE 1 FROM_H2', 1)
    #host_1.udt_send('H3', 'MESSAGE 2 FROM_H1', 1)
    #host_1.udt_send('H3', 'MESSAGE 3 FROM_H1', 3)
        #host_2.udt_send('H3', 'MESSAGE_%d_FROM_H2' % i, priority)
